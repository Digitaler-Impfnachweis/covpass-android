...
internal class RevocationExportViewModel constructor(
    ...
    fun onShareClick(data: ExpertModeData) {
        launch {
            val base64EncodedData = Base64.encodeToString(
                defaultJson.encodeToString(data).toByteArray(), Base64.DEFAULT
            )
